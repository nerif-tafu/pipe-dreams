  ...
  async function loadData() {
    try {
      ...
      if (itemsResponse.ok) {
        ...
        // If the file doesn't exist or returns an error, no game data
        noGameData = true;
      }
    ...
    {:else if noGameData}
      <div class="bg-blue-50 border border-blue-200 rounded-md p-6 text-center">
        ...
        <p class="text-blue-700 mb-4">
          You need to download Rust game data before you can manage item exclusions and variations.
        </p>
        <a 
          href="/data" 
                   ...
                   <div class="flex items-center justify-between p-3 bg-gray-50 rounded-md">
                     <div class="flex items-center">
                       ...
                       <div>
                         ...
                         title="Delete"
                         aria-label="Delete exclusion for {exclusion.itemName}"
                       >
                         <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <label class="bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700 transition-colors cursor-pointer flex items-center justify-center" title="Import">
                    ...
                    />
                     ...
                     aria-label="Add new variation group"
                   >
                     <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                       <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                     </svg>
                   ...
                   <div class="border border-gray-200 rounded-md p-4">
                     <div class="flex items-center justify-between mb-2">
                       ...
                       <div class="flex space-x-2">
                             ...
                             title="Edit"
                             aria-label="Edit variation group {group.name}"
                           >
                             <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                             ...
                             class="text-red-600 hover:text-red-800 text-sm flex items-center justify-center"
                             title="Delete"
                             aria-label="Delete variation group {group.name}"
                           >
                             <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                               <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                             </svg>
